...
import { FaExternalLinkAlt, FaFigma, FaGithub, FaImages, FaNode, FaReact, FaStripe } from 'react-icons/fa';
...
const projectsData = [
    {
        ...
        description: 'A website which is develop by ReactJS and back-end as a NodeJS with mongoDB and using dynamic data and also with CRM (Admin Panel).Design is totally done by HTML5 , CSS3 , Tailwind and for EJS file Bootstrap.',
    ...
    },
    {
        ...
        description: 'This website totally made in ReactJS and NodeJS. Design in HTML5 and tailwind',
        image: EMSImage,
    ...
    },
    {
        ...
        description: 'Panchal Samaj Application is completed in just 62 days in React Native and NodeJS with Admin Panel and totally data is dynamically. We launch this application on Vishwakarma jayanti.',
        image: panchalSamaj,
    ...
    },
    {
        ...
        description: 'Activity Management System (AMS) is a well-structured project that emphasizes effective communication through regular meetings. The design was facilitated with the aid of Figma, ensuring a clear and collaborative development process. This project was fully developed using React Native for the front end and Node.js for the back end.',
        image: AMSImage,
        technologies: ['JavaScript', 'React Native', "NodeJS"],
        projectLink: "https://play.google.com/store/apps/details?id=com.innovate10x.oms.router&pcampaignid=web_share",
    },
];
